 ...
 */
  ...
  /**
   * 265.
   * Problem: Check if a binary string has a 0 between 1s or not | Set 1 (General approach).
   * Solution:
   */

  /**
   * 266.
   * Problem: Extract maximum numeric value from a given string | Set 1 (General approach).
   * Solution:
   */

  /**
   * 267.
   * Problem: Find all the patterns of &#8220;1(0+)1&#8221; in a given string | SET 1(General Approach).
   * Solution:
   */
  ...
  /**
   * 269.
   * Problem: Baconian Cipher.
   * Solution:
   */

  /**
   * 270.
   * Problem: Count words present in a string.
   * Solution:
   */
  ...
  /**
   * 272.
   * Problem: Count number of strings (made of R, G and B) using given combination.
   * Solution:
   */

  /**
   * 273.
   * Problem: Lexicographically smallest rotated sequence | Set 2.
   * Solution:
   */

  /**
   * 274.
   * Problem: Find all the patterns of &#8220;1(0+)1&#8221; in a given string | SET 2(Regular Expression Approach).
   * Solution:
   */

  /**
   * 275.
   * Problem: Extract maximum numeric value from a given string | Set 2 (Regex approach).
   * Solution:
   */

  /**
   * 276.
   * Problem: Check if a binary string has a 0 between 1s or not | Set 2 (Regular Expression Approach).
   * Solution:
   */

  /**
   * 277.
   * Problem: Count of Palindromic substrings in an Index range.
   * Solution:
   */

  /**
   * 278.
   * Problem: Given a number as a string, find the number of contiguous subsequences which recursively add up to 9 | Set 2.
   * Solution:
   */

  /**
   * 279.
   * Problem: std::string::append vs std::string::push_back() vs Operator += in C++.
   * Solution:
   */

  /**
   * 280.
   * Problem: Print the string by ignoring alternate occurrences of any character.
   * Solution:
   */

  /**
   * 281.
   * Problem: Check if both halves of the string have same set of characters.
   * Solution:
   */
  ...
  /**
   * 283.
   * Problem: Calculate the difficulty of a sentence.
   * Solution:
   */

  /**
   * 284.
   * Problem: Nth Even length Palindrome.
   * Solution:
   */

  /**
   * 285.
   * Problem: Keyword Cipher.
   * Solution:
   */

  /**
   * 286.
   * Problem: Lexicographically n-th permutation of a string.
   * Solution:
   */

  /**
   * 287.
   * Problem: Find the character in first string that is present at minimum index in second string.
   * Solution:
   */

  /**
   * 288.
   * Problem: Print the string after the specified character has occurred given no. of times.
   * Solution:
   */
  ...
  /**
   * 290.
   * Problem: Quick way to check if all the characters of a string are same.
   * Solution:
   */

  /**
   * 291.
   * Problem: Calculate maximum value using &#8216;+&#8217; or &#8216;*&#8217; sign between two numbers in a string.
   * Solution:
   */

  /**
   * 292.
   * Problem: Given a sequence of words, print all anagrams together using STL.
   * Solution:
   */

  /**
   * 293.
   * Problem: Program to check if input is an integer or a string.
   * Solution:
   */

  /**
   * 294.
   * Problem: Maximum length substring having all same characters after k changes.
   * Solution:
   */
  ...
  /**
   * 296.
   * Problem: Min flips of continuous characters to make all characters same  in a string.
   * Solution:
   */

  /**
   * 297.
   * Problem: Count words that appear exactly two times in an array of words.
   * Solution:
   */
  ...
  /**
   * 300.
   * Problem: Find numbers of balancing positions in string.
   * Solution:
   */

  /**
   * 301.
   * Problem: Minimum rotations required to get the same string.
   * Solution:
   */

  /**
   * 302.
   * Problem: Ways to remove one element from a binary string so that XOR becomes zero.
   * Solution:
   */
  ...
  /**
   * 304.
   * Problem: Alphanumeric Abbreviations of a String.
   * Solution:
   */

  /**
   * 305.
   * Problem: Check if a string is Pangrammatic Lipogram.
   * Solution:
   */
  ...
  /**
   * 307.
   * Problem: Largest even number possible by using one swap operation in given number.
   * Solution:
   */

  /**
   * 308.
   * Problem: Minimum Index Sum for Common Elements of Two Lists.
   * Solution:
   */

  /**
   * 309.
   * Problem: Permute a string by changing case.
   * Solution:
   */

  /**
   * 310.
   * Problem: Convert all substrings of length &#8216;k&#8217; from base &#8216;b&#8217; to decimal.
   * Solution:
   */

  /**
   * 311.
   * Problem: Count of occurrences of a &#8220;1(0+)1&#8221; pattern in  a string.
   * Solution:
   */

  /**
   * 312.
   * Problem: Sentence Palindrome (Palindrome after removing spaces, dots, .. etc).
   * Solution:
   */

  /**
   * 313.
   * Problem: Minimum number of deletions so that no two consecutive are same.
   * Solution:
   */

  /**
   * 314.
   * Problem: Longest common substring in binary representation of two numbers.
   * Solution:
   */

  /**
   * 315.
   * Problem: Reverse words in a given String in Java.
   * Solution:
   */

  /**
   * 316.
   * Problem: Find n-th lexicographically permutation of a string | Set 2.
   * Solution:
   */

  /**
   * 317.
   * Problem: Lexicographic rank of a string using STL.
   * Solution:
   */
  ...
  /**
   * 320.
   * Problem: Roll the characters of string.
   * Solution:
   */

  /**
   * 321.
   * Problem: Print the longest common substring.
   * Solution:
   */

  /**
   * 322.
   * Problem: Efficiently find first repeated character in a string without using any additional data structure in one traversal.
   * Solution:
   */
  ...
  /**
   * 324.
   * Problem: Evaluate a boolean expression represented as string.
   * Solution:
   */

  /**
   * 325.
   * Problem: Print characters and their frequencies in order of occurrence.
   * Solution:
   */

  /**
   * 326.
   * Problem: Given two strings check which string makes a palindrome first.
   * Solution:
   */

  /**
   * 327.
   * Problem: Least number of manipulations needed to ensure two strings have identical characters.
   * Solution:
   */

  /**
   * 328.
   * Problem: Print all Subsequences of String which Start with Vowel and End with Consonant..
   * Solution:
   */
  ...
  /**
   * 331.
   * Problem: Count All Palindrome Sub-Strings in a String | Set 2.
   * Solution:
   */

  /**
   * 332.
   * Problem: Minimum Number of Manipulations required to make two Strings Anagram Without Deletion of Character.
   * Solution:
   */
  ...
  /**
   * 333.
   * Problem: Recursive solution to count substrings with same first and last characters.
   * Solution:
   */
  ...
  /**
   * 335.
   * Problem: Length of the smallest sub-string consisting of maximum distinct characters.
   * Solution:
   */

  /**
   * 336.
   * Problem: isupper() and islower() and their application in  C++.
   * Solution:
   */

  /**
   * 337.
   * Problem: Remove three consecutive duplicates from string.
   * Solution:
   */

  /**
   * 338.
   * Problem: Generating distinct subsequences of a given string  in lexicographic order.
   * Solution:
   */

  /**
   * 339.
   * Problem: Check if any anagram of a string is palindrome or not.
   * Solution:
   */

  /**
   * 340.
   * Problem: Concatenated string with uncommon characters of two strings.
   * Solution:
   */

  /**
   * 341.
   * Problem: Longest subsequence where every character appears at-least k times.
   * Solution:
   */

  /**
   * 342.
   * Problem: Frequency of a string in an array of strings.
   * Solution:
   */
  ...
  /**
   * 346.
   * Problem: Binary representation of previous number.
   * Solution:
   */

  /**
   * 347.
   * Problem: Decode an Encoded Base 64 String to ASCII String.
   * Solution:
   */

  /**
   * 348.
   * Problem: Number of substrings with count of each character as k.
   * Solution:
   */

  /**
   * 349.
   * Problem: Find substrings that contain all vowels.
   * Solution:
   */

  /**
   * 350.
   * Problem: Longest substring of vowels.
   * Solution:
   */

  /**
   * 351.
   * Problem: Find repeated character present first in a string.
   * Solution:
   */

  /**
   * 352.
   * Problem: Lexicographically first alternate vowel and consonant string.
   * Solution:
   */

  /**
   * 353.
   * Problem: Distributing all balls without repetition.
   * Solution:
   */

  /**
   * 354.
   * Problem: Luhn algorithm.
   * Solution:
   */
  ...
  /**
   * 356.
   * Problem: Program to find the initials of a name..
   * Solution:
   */

  /**
   * 357.
   * Problem: Most frequent word in an array of strings.
   * Solution:
   */

  /**
   * 358.
   * Problem: Find winner of an election where votes are represented as candidate names.
   * Solution:
   */

  /**
   * 359.
   * Problem: Program for credit card number validation.
   * Solution:
   */

  /**
   * 360.
   * Problem: Make a string from another by deletion and rearrangement of characters.
   * Solution:
   */

  /**
   * 361.
   * Problem: Longest Common Substring in an Array of Strings.
   * Solution:
   */

  /**
   * 362.
   * Problem: Reversing an Equation.
   * Solution:
   */

  /**
   * 363.
   * Problem: Generate two output strings depending upon occurrence of character in input string..
   * Solution:
   */

  /**
   * 364.
   * Problem: Count of substrings of a binary string containing K ones.
   * Solution:
   */

  /**
   * 365.
   * Problem: Compare two strings lexicographically in Java.
   * Solution:
   */

  /**
   * 366.
   * Problem: Check if a two character string can be made using given words.
   * Solution:
   */

  /**
   * 367.
   * Problem: Number of positions where a letter can be inserted such that a string becomes palindrome.
   * Solution:
   */

  /**
   * 368.
   * Problem: Rearrange a binary string as alternate x and y occurrences.
   * Solution:
   */

  /**
   * 369.
   * Problem: Minimal operations to make a number magical.
   * Solution:
   */

  /**
   * 370.
   * Problem: Shortest substring of a string containing all given words.
   * Solution:
   */

  /**
   * 371.
   * Problem: Lexicographically largest subsequence such that every character occurs at least k times.
   * Solution:
   */

  /**
   * 372.
   * Problem: stringstream in C++ and its applications.
   * Solution:
   */
  ...
  /**
   * 374.
   * Problem: Lexicographically smallest string whose hamming distance from given string is exactly K.
   * Solution:
   */

  /**
   * 375.
   * Problem: Common characters in n strings.
   * Solution:
   */
  ...
  /**
   * 378.
   * Problem: Reverse string in Python (5 different ways).
   * Solution:
   */

  /**
   * 379.
   * Problem: Minimum reduce operations to covert a given string into a palindrome.
   * Solution:
   */

  /**
   * 380.
   * Problem: Remove all consecutive duplicates from the string.
   * Solution:
   */

  /**
   * 381.
   * Problem: Burrows &#8211; Wheeler Data Transform Algorithm.
   * Solution:
   */
  ...
  /**
   * 383.
   * Problem: Length of the longest substring with equal 1s and 0s.
   * Solution:
   */

  /**
   * 384.
   * Problem: String with k distinct characters and no same characters adjacent.
   * Solution:
   */

  /**
   * 385.
   * Problem: Lexicographically next string.
   * Solution:
   */

  /**
   * 386.
   * Problem: Compare Version Numbers with large inputs allowed.
   * Solution:
   */

  /**
   * 387.
   * Problem: Inverting the Burrows &#8211; Wheeler Transform.
   * Solution:
   */

  /**
   * 388.
   * Problem: Possibility of a word from a given set of characters.
   * Solution:
   */
  ...
  /**
   * 390.
   * Problem: Minimum number of stops from given path.
   * Solution:
   */

  /**
   * 391.
   * Problem: Maximum number of characters between any two same character in a string.
   * Solution:
   */

  /**
   * 392.
   * Problem: Remove all duplicates from a given string in Python.
   * Solution:
   */

  /**
   * 393.
   * Problem: Minimum move to end operations to make all strings equal.
   * Solution:
   */
  ...
  /**
   * 395.
   * Problem: Run Length Encoding in Python.
   * Solution:
   */

  /**
   * 396.
   * Problem: Anagram checking in Python using collections.Counter().
   * Solution:
   */

  /**
   * 397.
   * Problem: Decode a median string to the original string.
   * Solution:
   */

  /**
   * 398.
   * Problem: K’th Non-repeating Character in Python using List Comprehension and OrderedDict.
   * Solution:
   */

  /**
   * 399.
   * Problem: Program to check Strength of Password.
   * Solution:
   */

  /**
   * 400.
   * Problem: Generate permutations with only adjacent swaps allowed.
   * Solution:
   */

  /**
   * 401.
   * Problem: Print words of a string in reverse order.
   * Solution:
   */
  ...
  /**
   * 403.
   * Problem: Prefix matching in Python using pytrie module.
   * Solution:
   */

  /**
   * 404.
   * Problem: Print number with commas as 1000 separators in Python.
   * Solution:
   */
  ...
  /**
   * 406.
   * Problem: Reverse words in a given String in Python.
   * Solution:
   */

  /**
   * 407.
   * Problem: Remove all characters other than alphabets from string.
   * Solution:
   */

  /**
   * 408.
   * Problem: Print anagrams together in Python using List and Dictionary.
   * Solution:
   */

  /**
   * 409.
   * Problem: Longest subsequence of the form 0*1*0* in a binary string.
   * Solution:
   */
  ...
  /**
   * 411.
   * Problem: Using OrderedDict() in Python to check order of characters in string.
   * Solution:
   */

  /**
   * 412.
   * Problem: Program to find remainder when large number is divided by 11.
   * Solution:
   */

  /**
   * 413.
   * Problem: Using Counter() in Python to find minimum character removal to make two strings anagram.
   * Solution:
   */

  /**
   * 414.
   * Problem: Program to check for ISBN.
   * Solution:
   */

  /**
   * 415.
   * Problem: Print all subsequences of a string | Iterative Method.
   * Solution:
   */

  /**
   * 416.
   * Problem: Binary tree to string with brackets.
   * Solution:
   */

  /**
   * 417.
   * Problem: String slicing in Python to check if a string can become empty by recursive deletion.
   * Solution:
   */

  /**
   * 418.
   * Problem: Encoding a word into Pig Latin.
   * Solution:
   */

  /**
   * 419.
   * Problem: Using Set() in Python Pangram Checking.
   * Solution:
   */

  /**
   * 420.
   * Problem: Minimum cost to convert string into palindrome.
   * Solution:
   */

  /**
   * 421.
   * Problem: Number of subsequences as &#8220;ab&#8221; in a string repeated K times.
   * Solution:
   */

  /**
   * 422.
   * Problem: Possible Words using given characters in Python.
   * Solution:
   */

  /**
   * 423.
   * Problem: Binary String of given length that without a palindrome of size 3.
   * Solution:
   */

  /**
   * 424.
   * Problem: Minimum Word Break.
   * Solution:
   */
  ...
  /**
   * 426.
   * Problem: Mirror characters of a string.
   * Solution:
   */

  /**
   * 427.
   * Problem: Convert string to char array in C++.
   * Solution:
   */

  /**
   * 428.
   * Problem: Frequency of a substring in a string.
   * Solution:
   */

  /**
   * 429.
   * Problem: Count of operations to make a binary string&#8221;ab&#8221; free.
   * Solution:
   */

  /**
   * 430.
   * Problem: Different substrings in a string that start and end with given strings.
   * Solution:
   */

  /**
   * 431.
   * Problem: String slicing in Python to rotate a string.
   * Solution:
   */
  ...
  /**
   * 433.
   * Problem: Change string to a new character set.
   * Solution:
   */

  /**
   * 434.
   * Problem: Python code to move spaces to front of string in single traversal.
   * Solution:
   */

  /**
   * 435.
   * Problem: Find minimum shift for longest common prefix.
   * Solution:
   */

  /**
   * 436.
   * Problem: Python code to print common characters of two Strings in alphabetical order.
   * Solution:
   */
  ...
  /**
   * 438.
   * Problem: Move To Front Data Transform Algorithm.
   * Solution:
   */

  /**
   * 439.
   * Problem: Construct lexicographically smallest palindrome.
   * Solution:
   */

  /**
   * 440.
   * Problem: Inverting the Move to Front Transform.
   * Solution:
   */
  ...
  /**
   * 442.
   * Problem: Camel case of a given sentence.
   * Solution:
   */

  /**
   * 443.
   * Problem: Regex in Python to put spaces between words starting with capital letters.
   * Solution:
   */

  /**
   * 444.
   * Problem: Tokenizing a string in C++.
   * Solution:
   */

  /**
   * 445.
   * Problem: Python Regex to extract maximum numeric value from a string.
   * Solution:
   */
  ...
  /**
   * 447.
   * Problem: Second most repeated word in a sequence in Python.
   * Solution:
   */

  /**
   * 448.
   * Problem: Concatenated string with uncommon characters in Python.
   * Solution:
   */

  /**
   * 449.
   * Problem: Split the string into substrings using delimiter.
   * Solution:
   */

  /**
   * 450.
   * Problem: Check if both halves of the string have same set of characters in Python.
   * Solution:
   */

  /**
   * 451.
   * Problem: Sums of ASCII values of each word in a sentence.
   * Solution:
   */

  /**
   * 452.
   * Problem: Decimal to octal conversion with minimum use of arithmetic operators.
   * Solution:
   */

  /**
   * 453.
   * Problem: Sum of first K even-length Palindrome numbers.
   * Solution:
   */

  /**
   * 454.
   * Problem: Minimum cost to construct a string.
   * Solution:
   */

  /**
   * 455.
   * Problem: Count occurrences of a word in string.
   * Solution:
   */
  ...
  /**
   * 457.
   * Problem: Fibonacci Word.
   * Solution:
   */

  /**
   * 458.
   * Problem: Dictionary and counter in Python to find winner of election.
   * Solution:
   */

  /**
   * 459.
   * Problem: Maximum length of consecutive 1&#8217;s in a binary string in Python using Map function.
   * Solution:
   */

  /**
   * 460.
   * Problem: Length of longest balanced parentheses prefix.
   * Solution:
   */
  ...
  /**
   * 463.
   * Problem: Replace a character c1 with c2 and c2 with c1 in a string S.
   * Solution:
   */

  /**
   * 464.
   * Problem: Find last index of a character in a string.
   * Solution:
   */

  /**
   * 465.
   * Problem: Python counter and dictionary intersection example (Make a string using deletion and rearrangement).
   * Solution:
   */

  /**
   * 466.
   * Problem: Python | Print the initials of a name with last name in full.
   * Solution:
   */

  /**
   * 467.
   * Problem: Program to implement ASCII lookup table.
   * Solution:
   */
  ...
  /**
   * 469.
   * Problem: Breaking a number such that first part is integral division of second by a power of 10.
   * Solution:
   */

  /**
   * 470.
   * Problem: Position of robot after given movements.
   * Solution:
   */

  /**
   * 471.
   * Problem: SequenceMatcher in Python for Longest Common Substring.
   * Solution:
   */

  /**
   * 472.
   * Problem: Program to check if a number belongs to a particular base or not.
   * Solution:
   */

  /**
   * 473.
   * Problem: Encrypt string with product of number of vowels and consonants in substring of size k.
   * Solution:
   */

  /**
   * 474.
   * Problem: Zip function in Python to change to a new character set.
   * Solution:
   */

  /**
   * 475.
   * Problem: Map function and Lambda expression in Python to replace characters.
   * Solution:
   */

  /**
   * 476.
   * Problem: Map function and Dictionary in Python to sum ASCII values.
   * Solution:
   */

  /**
   * 477.
   * Problem: Print number of words, vowels and frequency of each character.
   * Solution:
   */
  ...
  /**
   * 479.
   * Problem: Next word that does not contain a palindrome and has characters from first k.
   * Solution:
   */

  /**
   * 480.
   * Problem: Program to count vowels, consonant, digits and special characters in string..
   * Solution:
   */

  /**
   * 481.
   * Problem: Form the largest palindromic number using atmost two swaps.
   * Solution:
   */

  /**
   * 482.
   * Problem: Find the size of largest subset of anagram words.
   * Solution:
   */
  ...
  /**
   * 484.
   * Problem: Python sorted() to check if two strings are anagram or not.
   * Solution:
   */

  /**
   * 485.
   * Problem: Python | Check if a Substring is Present in a Given String.
   * Solution:
   */

  /**
   * 486.
   * Problem: Python set to check if string is panagram.
   * Solution:
   */

  /**
   * 487.
   * Problem: Program to check for a Valid IMEI Number.
   * Solution:
   */

  /**
   * 488.
   * Problem: Python program to count number of vowels using sets in given string.
   * Solution:
   */

  /**
   * 489.
   * Problem: Count subsequence of length three in a given string.
   * Solution:
   */

  /**
   * 490.
   * Problem: Minimum equal palindromic cuts with rearrangements allowed.
   * Solution:
   */
  ...
  /**
   * 492.
   * Problem: Snake case of a given sentence.
   * Solution:
   */

  /**
   * 493.
   * Problem: Subsequence queries after removing substrings.
   * Solution:
   */

  /**
   * 494.
   * Problem: Print given sentence into its equivalent ASCII form.
   * Solution:
   */

  /**
   * 495.
   * Problem: Check whether a given string is Heterogram or not.
   * Solution:
   */

  /**
   * 496.
   * Problem: Program to print characters present at prime indexes in a given string.
   * Solution:
   */

  /**
   * 497.
   * Problem: Java program to swap first and last characters of words in a sentence.
   * Solution:
   */

  /**
   * 498.
   * Problem: Java program to count the characters in each word in a given sentence.
   * Solution:
   */

  /**
   * 499.
   * Problem: Panalphabetic window in a string.
   * Solution:
   */

  /**
   * 500.
   * Problem: Longest Common Anagram Subsequence.
   * Solution:
   */

  /**
   * 501.
   * Problem: Python groupby method  to remove all consecutive duplicates.
   * Solution:
   */

  /**
   * 502.
   * Problem: Generate two output strings depending upon occurrence of character in input string in Python.
   * Solution:
   */
  ...
  /**
   * 504.
   * Problem: Python Dictionary to find mirror characters in a string.
   * Solution:
   */

  /**
   * 505.
   * Problem: Find the arrangement of queue at given time.
   * Solution:
   */

  /**
   * 506.
   * Problem: Print a closest string that does not contain adjacent duplicates.
   * Solution:
   */

  /**
   * 507.
   * Problem: Count subsequences in first string which are anagrams of the second string.
   * Solution:
   */

  /**
   * 508.
   * Problem: Longest sub-string having frequency of each character less than equal to k.
   * Solution:
   */

  /**
   * 509.
   * Problem: Find a string in lexicographic order which is in between given two strings.
   * Solution:
   */

  /**
   * 510.
   * Problem: Find the starting indices of the substrings in string (S) which is made by concatenating all words from a list(L).
   * Solution:
   */
  ...
  /**
   * 512.
   * Problem: Print all the palindromic permutations of given string in alphabetic order.
   * Solution:
   */

  /**
   * 513.
   * Problem: Counting k-mers via Suffix Array.
   * Solution:
   */

  /**
   * 514.
   * Problem: Count number of equal pairs in a string.
   * Solution:
   */
  ...
  /**
   * 516.
   * Problem: Java program to expand a String if range is given?.
   * Solution:
   */

  /**
   * 517.
   * Problem: Number of substrings with odd decimal value in a binary string.
   * Solution:
   */

  /**
   * 518.
   * Problem: Remove the forbidden strings.
   * Solution:
   */

  /**
   * 519.
   * Problem: Missing Permutations in a list.
   * Solution:
   */
  ...
  /**
   * 521.
   * Problem: K distant string.
   * Solution:
   */

  /**
   * 522.
   * Problem: Covert string X to an anagram of string Y with minimum replacements.
   * Solution:
   */

  /**
   * 523.
   * Problem: Reduce Hamming distance by swapping two characters.
   * Solution:
   */
  ...
  /**
   * 526.
   * Problem: Count consonants in a string (Iterative and recursive methods).
   * Solution:
   */
  ...
  /**
   * 528.
   * Problem: Generate all the binary number from 0 to n.
   * Solution:
   */

  /**
   * 529.
   * Problem: Program for length of a string using recursion.
   * Solution:
   */

  /**
   * 530.
   * Problem: Make a lexicographically smallest palindrome with minimal changes.
   * Solution:
   */

  /**
   * 531.
   * Problem: Merge two strings in chunks of given size.
   * Solution:
   */

  /**
   * 532.
   * Problem: Interchanging first and second halves of stings.
   * Solution:
   */

  /**
   * 533.
   * Problem: Create a new string by alternately combining the characters of two halves of the string in reverse.
   * Solution:
   */

  /**
   * 534.
   * Problem: Counting even decimal value substrings in a binary string.
   * Solution:
   */

  /**
   * 535.
   * Problem: Lexicographic rank of a string with duplicate characters.
   * Solution:
   */

  /**
   * 536.
   * Problem: Count maximum-length palindromes in a String.
   * Solution:
   */

  /**
   * 537.
   * Problem: First uppercase letter in a string (Iterative and Recursive).
   * Solution:
   */
  ...
  /**
   * 539.
   * Problem: gOOGLE cASE of a given sentence.
   * Solution:
   */

  /**
   * 540.
   * Problem: Lexicographical concatenation of all substrings of a string.
   * Solution:
   */
  ...
  /**
   * 542.
   * Problem: Splitting a Numeric String.
   * Solution:
   */

  /**
   * 543.
   * Problem: String from prefix and suffix of given two strings.
   * Solution:
   */
  ...
  /**
   * 546.
   * Problem: Queries for frequencies of characters in substrings.
   * Solution:
   */
  ...
  /**
   * 548.
   * Problem: Convert the string into palindrome string by changing only one character..
   * Solution:
   */

  /**
   * 549.
   * Problem: Program to build DFA that starts and end with &#8216;a&#8217; from input (a, b).
   * Solution:
   */

  /**
   * 550.
   * Problem: Concatenation of two strings in PHP.
   * Solution:
   */

  /**
   * 551.
   * Problem: Maximum distinct lowercase alphabets between two uppercase.
   * Solution:
   */
  ...
  /**
   * 554.
   * Problem: Converting one string to other using append and delete last operations.
   * Solution:
   */

  /**
   * 555.
   * Problem: Longest subsequence where each character occurs at least k times.
   * Solution:
   */

  /**
   * 556.
   * Problem: Consecutive sequenced numbers in a string.
   * Solution:
   */
  ...
  /**
   * 558.
   * Problem: Comparing two strings in C++.
   * Solution:
   */

  /**
   * 559.
   * Problem: Sum of all subsequences of a number.
   * Solution:
   */

  /**
   * 560.
   * Problem: Substrings starting with vowel and ending with consonants and vice versa.
   * Solution:
   */

  /**
   * 561.
   * Problem: Time complexity of all permutations of a string.
   * Solution:
   */

  /**
   * 562.
   * Problem: Print distinct sorted permutations with duplicates allowed in input.
   * Solution:
   */
  ...
  /**
   * 564.
   * Problem: Longest prefix which is also suffix.
   * Solution:
   */

  /**
   * 565.
   * Problem: Rearrange characters to form palindrome if possible.
   * Solution:
   */
  ...
  /**
   * 567.
   * Problem: Practice questions on Strings.
   * Solution:
   */
  ...
  /**
   * 570.
   * Problem: Remove all the palindromic words from the given sentence.
   * Solution:
   */

  /**
   * 571.
   * Problem: Maximum segment value after putting k breakpoints in a number.
   * Solution:
   */

  /**
   * 572.
   * Problem: Sparse Search.
   * Solution:
   */

  /**
   * 573.
   * Problem: Partition given string in such manner that i&#8217;th substring is sum of (i-1)&#8217;th and (i-2)&#8217;th substring.
   * Solution:
   */

  /**
   * 574.
   * Problem: Minimum removal to make palindrome permutation.
   * Solution:
   */

  /**
   * 575.
   * Problem: Tribonacci Word.
   * Solution:
   */

  /**
   * 576.
   * Problem: Polybius Square Cipher.
   * Solution:
   */

  /**
   * 577.
   * Problem: Morse Code Implementation.
   * Solution:
   */

  /**
   * 578.
   * Problem: Find i&#8217;th Index character in a binary string obtained after n iterations.
   * Solution:
   */

  /**
   * 579.
   * Problem: Closest Palindrome Number (absolute difference Is min).
   * Solution:
   */

  /**
   * 580.
   * Problem: Find if a string starts and ends with another given string.
   * Solution:
   */

  /**
   * 581.
   * Problem: Program for length of the longest word in a sentence.
   * Solution:
   */

  /**
   * 582.
   * Problem: String with maximum number of unique characters.
   * Solution:
   */

  /**
   * 583.
   * Problem: Sort the given string using character search.
   * Solution:
   */

  /**
   * 584.
   * Problem: Check if two strings have a common substring.
   * Solution:
   */

  /**
   * 585.
   * Problem: Product of nodes at k-th level in a tree represented as string.
   * Solution:
   */

  /**
   * 586.
   * Problem: Count special palindromes in a String.
   * Solution:
   */

  /**
   * 587.
   * Problem: Evaluate an array expression with numbers, + and &#8211;.
   * Solution:
   */

  /**
   * 588.
   * Problem: Number of strings of length N with no palindromic sub string.
   * Solution:
   */
