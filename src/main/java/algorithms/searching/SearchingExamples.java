...
public class SearchingExamples {
  ...
  /**
   * 17.
   * Problem: The Ubiquitous Binary Search | Set 1.
   * Solution:
   */
  ...
  /**
   * 19.
   * Problem: Given an array of of size n and a number k, find all elements that appear more than n/k times.
   * Solution:
   */
  ...
  /**
   * 25.
   * Problem: Recursive  program to linearly search an element in a given array.
   * Solution:
   */
  ...
  /**
   * 28.
   * Problem: A Problem in Many Binary Search Implementations.
   * Solution:
   */
  ...
  /**
   * 35.
   * Problem: K&#8217;th Smallest/Largest Element in Unsorted Array | Set 2 (Expected Linear Time).
   * Solution:
   */
  ...
  /**
   * 37.
   * Problem: K&#8217;th Smallest/Largest Element in Unsorted Array | Set 3 (Worst Case Linear Time).
   * Solution:
   */

  /**
   * 38.
   * Problem: Why is Binary Search preferred over Ternary Search?.
   * Solution:
   */
  ...
  /**
   * 42.
   * Problem: Find the nearest smaller numbers on left side in an array.
   * Solution:
   */
  ...
  /**
   * 45.
   * Problem: Find a pair with maximum product in array of Integers.
   * Solution:
   */
  ...
  /**
   * 47.
   * Problem: Find the odd appearing element in O(Log n) time.
   * Solution:
   */
  ...
  /**
   * 49.
   * Problem: Search an element in an array where difference between adjacent elements is 1.
   * Solution:
   */

  /**
   * 50.
   * Problem: Find three closest elements from given three sorted arrays.
   * Solution:
   */

  /**
   * 51.
   * Problem: Find the element before which all the elements are smaller than it, and after which all are greater.
   * Solution:
   */

  /**
   * 52.
   * Problem: Binary Search for Rational Numbers without using floating point arithmetic.
   * Solution:
   */

  /**
   * 53.
   * Problem: Fibonacci Search.
   * Solution:
   */
  ...
  /**
   * 59.
   * Problem: Linear Search vs Binary Search.
   * Solution:
   */
  ...
  /**
   * 61.
   * Problem: Queries for greater than and not less than.
   * Solution:
   */

  /**
   * 62.
   * Problem: Efficient search in an array where difference between adjacent is 1.
   * Solution:
   */
  ...
  /**
   * 64.
   * Problem: Print all possible sums of consecutive numbers with sum N.
   * Solution:
   */

  /**
   * 65.
   * Problem: Minimum time required to produce m items.
   * Solution:
   */
  ...
  /**
   * 67.
   * Problem: Make all array elements equal with minimum cost.
   * Solution:
   */
  ...
  /**
   * 78.
   * Problem: Count of only repeated element in a sorted array of consecutive elements.
   * Solution:
   */
